...
Config.PenalCode = {
    [1] = {
        ...
        [5] = {title = 'Involuntary Manslaughter', class = 'Felony', id = 'P.C. 1005', months = 10, fine = 4500, color = 'red', description = 'Recklessly or accidentally kills another person without premeditation'},
        [6] = {title = 'Vehicular Manslaughter', class = 'Felony', id = 'P.C. 1006', months = 10, fine = 4500, color = 'red', description = 'Recklessly or accidentally kills another person while driving a motor vehicle.'},
        ...
        [10] = {title = 'First Degree Murder', class = 'Felony', id = 'P.C. 1010', months = 15, fine = 5000, color = 'red', description = 'Kills another person with the intent to kill with premeditation and deliberation.'},
        [11] = {title = 'Accessory to First Degree Murder', class = 'Felony', id = 'P.C. 1011', months = 9, fine = 3500, color = 'red', description = 'A person commits the offense when they help an individual Kills another person with the intent to kill with premeditation and deliberation.'},
        [12] = {title = 'Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1012', months = 18, fine = 7500, color = 'red', description = 'Attempting to commit homicide against one or more Peace Officers.  This charge can only be handed once per scene, not per Peace Officer being shot at.'},
        [13] = {title = 'Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1013', months = 9, fine = 3500, color = 'red', description = 'Attempting to commit homicide against one or more Peace Officers.  This charge can only be handed once per scene, not per Peace Officer being shot at. '},
    ...
    [2] = {
        ...
        [11] = {title = 'Accessory to Robbery of a financial institution', class = 'Felony', id = 'P.C. 2011', months = 3, fine = 1500, color = 'red', description = 'A person commits the offense when they help an individual commit Robbery or attempted robbery of any bank or financial institution, including Pacific Standard or Vangelico'},
        [12] = {title = 'Attempted Robbery of a financial institution', class = 'Felony', id = 'P.C. 2012', months = 5, fine = 1500, color = 'red', description = 'Attempting to commit Robbery or attempted robbery of any bank or financial institution, including Pacific Standard or Vangelico'},
        [13] = {title = 'Government Grand Larceny', class = 'Felony', id = 'P.C. 2013', months = 5, fine = 1500, color = 'red', description = 'The unlawful taking of government property worth more than $2000'},
        ...
        [15] = {title = 'Possession of Counterfeit Items', class = 'Misdemeanor', id = 'P.C. 2015', months = 2, fine = 750, color = 'orange', description = 'a person who is in possesses or receives, with the intent to pass or facilitate the passage or utterance of any forged, altered, or counterfeit items, or completed items contained in subdivision (d) of Section 470 with intent to defraud, knowing the same to be forged, altered, or counterfeit, is guilty of forgery.'},
        [16] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2016', months = 5, fine = 6500, color = 'orange', description = 'he unlawful taking or reciveing of government property or items.'},
        [17] = {title = 'Possession of Items Used in the Commission of a Crime', class = 'Misdemeanor', id = 'P.C. 2017', months = 3, fine = 600, color = 'orange', description = 'Possession of any items used in the commission of any charge.  The list of these items are defined above. '},
        [18] = {title = 'Sale of Items Used in the Commission of a Crime', class = 'Felony', id = 'P.C. 2018', months = 4, fine = 1000, color = 'red', description = 'sale of any items used in the commission of any charge.  The list of these items are defined above.'},
        [19] = {title = 'Theft of an Aircraft', class = 'Felony', id = 'P.C. 2019', months = 6, fine = 1000, color = 'red', description = 'Unlawfully taking a Aircraft belonging to another, or flying the vehicle without the owners consent, with the intent to permanently or temporarily deprive the owner of the Aircraft'},
    },
    [3] = {
    ...
    [5] = {
        [1] = {title = 'Bribery', class = 'Felony', id = 'P.C. 5001', months = 6, fine = 3500, color = 'red', description = 'Paying or agreeing to pay a public servant in exchange for an influenced vote, opinion, or other action from that public servant.'},
    ...
    [8] = {
        ...
        [7] = {title = 'Felony Criminal Discharge of Weapon', class = 'Felony', id = 'P.C. 8009', months = 4, fine = 1450, color = 'red', description = 'The act of using of any weapon unlawfully by pointing or discharging while in the act of committing a felony.'},
        ...
        [15] = {title = 'Criminal Possession of Explosives', class = 'Felony', id = 'P.C. 8016', months = 3, fine = 2500, color = 'red', description = 'Being in possession of any Explosives unlawfully such as C4, thermite or Explosives'},
    },
    [9] = {
        ...
        [12] = {title = 'Unlicensed Operation of Vehicle', class = 'Misdemeanor', id = 'P.C. 9012', months = 1, fine = 500, color = 'orange', description = 'operating a motor vehicle without a proper license on the person.'},
        ...
        [21] = {title = 'Street Racing', class = 'Felony', id = 'P.C. 9021', months = 3, fine = 1500, color = 'Felony', description = 'Participating in a race with other motorized vehicles on a public street.'},
        [22] = {title = 'Piloting without Proper Licensing', class = 'Felony', id = 'P.C. 9022', months = 5, fine = 1500, color = 'red', description = 'Piloting without a Licensing without'},
        ...
        [24] = {title = 'Impeding Traffic', class = 'Misdemeanor', id = 'P.C. 9024', months = 0, fine = 650, color = 'orange', description = 'The act of blocking the flow of traffic on a public road or idling/stopping the vehicle in the middle of traffic.'},
    },
    [10] = {

...
Config.PenalCode = {
    ...
    [2] = {
        ...
        [11] = {title = 'Robbery of ATM', class = 'Felony', id = 'P.C. 2010', months = 4, fine = 2500, color = 'red', description = 'Robbery or attempted robbery of any bank operated ATMs'},
        ...
        [14] = {title = 'Government Grand Larceny', class = 'Felony', id = 'P.C. 2013', months = 5, fine = 1500, color = 'red', description = 'The unlawful taking of government property worth more than $2000'},
        [15] = {title = 'Theft of Service', class = 'Infraction', id = 'P.C. 2014', months = 0, fine = 600, color = 'green', description = 'A person commits theft of service if, with intent to avoid payment for service that the actor knows is provided only for compensation'},
        [16] = {title = 'Possession of Counterfeit Items', class = 'Misdemeanor', id = 'P.C. 2015', months = 2, fine = 750, color = 'orange', description = 'a person who is in possesses or receives, with the intent to pass or facilitate the passage or utterance of any forged, altered, or counterfeit items, or completed items contained in subdivision (d) of Section 470 with intent to defraud, knowing the same to be forged, altered, or counterfeit, is guilty of forgery.'},
        [17] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2016', months = 5, fine = 6500, color = 'orange', description = 'he unlawful taking or reciveing of government property or items.'},
        [18] = {title = 'Possession of Items Used in the Commission of a Crime', class = 'Misdemeanor', id = 'P.C. 2017', months = 3, fine = 600, color = 'orange', description = 'Possession of any items used in the commission of any charge.  The list of these items are defined above. '},
        [19] = {title = 'Sale of Items Used in the Commission of a Crime', class = 'Felony', id = 'P.C. 2018', months = 4, fine = 1000, color = 'red', description = 'sale of any items used in the commission of any charge.  The list of these items are defined above.'},
        [20] = {title = 'Theft of an Aircraft', class = 'Felony', id = 'P.C. 2019', months = 5, fine = 1000, color = 'red', description = 'Unlawfully taking a Aircraft belonging to another, or flying the vehicle without the owners consent, with the intent to permanently or temporarily deprive the owner of the Aircraft'},
    },
    [3] = {
    ...
    [5] = {
        [1] = {title = 'Bribery', class = 'Felony', id = 'P.C. 5001', months = 6, fine = 2500, color = 'red', description = 'Paying or agreeing to pay a public servant in exchange for an influenced vote, opinion, or other action from that public servant.'},

...
Config.PenalCode = {
    [1] = {
        [1] = {title = 'Simple Assault', class = 'Misdemeanor', id = 'P.C. 1001', months = 1, fine = 500, color = 'green', description = 'When a person intentionally or knowingly causes physical contact with another (without a weapon)'},
        [2] = {title = 'Assault', class = 'Misdemeanor', id = 'P.C. 1002', months = 2, fine = 850, color = 'orange', description = 'If a person intentionally or knowingly causes injury to another (without a weapon)'},
        [3] = {title = 'Aggravated Assault', class = 'Felony', id = 'P.C. 1003', months = 4, fine = 1250, color = 'orange', description = 'When a person unintentionally, and recklessly causes bodily injury to another as a result of a confrontation AND causes bodily injury'},
        [4] = {title = 'Assault with a Deadly Weapon', class = 'Felony', id = 'P.C. 1004', months = 5, fine = 2500, color = 'red', description = 'When a person intentionally, knowingly, or recklessly causes bodily injury to another person AND either causes serious bodily injury or uses or exhibits a deadly weapon'},
        ...
        [7] = {title = 'Attempted Murder of a Civilian', class = 'Felony', id = 'P.C. 1007', months = 7, fine = 5620, color = 'red', description = 'When a non-government person intentionally attacks another with the intent to kill'},
        [8] = {title = 'Second Degree Murder', class = 'Felony', id = 'P.C. 1008', months = 20, fine = 6500, color = 'red', description = 'Any intentional killing that is not premeditated or planned. A situation in which the killer intends only to inflict serious bodily harm.'},
        [9] = {title = 'Accessory to Second Degree Murder', class = 'Felony', id = 'P.C. 1009', months = 10, fine = 3300, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        [10] = {title = 'First Degree Murder', class = 'Felony', id = 'P.C. 1010', months = 20, fine = 6000, color = 'red', description = 'Any intentional killing that is willful and premeditated with malice.'},
        [11] = {title = 'Accessory to First Degree Murder', class = 'Felony', id = 'P.C. 1011', months = 10, fine = 2500, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        [12] = {title = 'Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1012', months = 14, fine = 8500, color = 'red', description = 'Any intentional killing that is done to a government employee'},
        [13] = {title = 'Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1013', months = 7, fine = 4500, color = 'red', description = 'Any attacks that are done to a government employee with the intent to cause death'},
        [14] = {title = 'Accessory to the Murder or Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1014', months = 5, fine = 3500, color = 'red', description = 'Being present and or participating in the act of parent charge'},
        [15] = {title = 'Unlawful Imprisonment', class = 'Misdemeanor', id = 'P.C. 1015', months = 4, fine = 600, color = 'green', description = 'The act of taking another against their will and holding them for an extended period of time'},
        [16] = {title = 'Kidnapping', class = 'Felony', id = 'P.C. 1016', months = 5, fine = 1900, color = 'orange', description = 'The act of taking another against their will for a short period of time'},
        [17] = {title = 'Accessory to Kidnapping', class = 'Felony', id = 'P.C. 1017', months = 3, fine = 850, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        [18] = {title = 'Attempted Kidnapping', class = 'Felony', id = 'P.C. 1018', months = 3, fine = 750, color = 'orange', description = 'The act of trying to take someone against their will'},
        [19] = {title = 'Hostage Taking', class = 'Felony', id = 'P.C. 1019', months = 5, fine = 1200, color = 'orange', description = 'The act of taking another against their will for personal gain'},
        [20] = {title = 'Accessory to Hostage Taking', class = 'Felony', id = 'P.C. 1020', months = 2, fine = 600, color = 'orange', description = 'Being present and or participating in the act of parent charge'},
        ...
        [22] = {title = 'Criminal Threats', class = 'Misdemeanor', id = 'P.C. 1022', months = 2, fine = 500, color = 'orange', description = 'The act of stating the intent to commit a crime against another'},
        [23] = {title = 'Reckless Endangerment', class = 'Misdemeanor', id = 'P.C. 1023', months = 2, fine = 1000, color = 'orange', description = 'The act of disregarding safety of another which may place another in danger of death or bodily injury'},
        [24] = {title = 'Gang Related Shooting', class = 'Felony', id = 'P.C. 1024', months = 7, fine = 2500, color = 'red', description = 'The act in which a firearm is discharged in relation to gang activity'},
        [25] = {title = 'Cannibalism', class = 'Felony', id = 'P.C. 1025', months = 15, fine = 10010, color = 'red', description = 'The act in which a persons consumes the flesh of another willingly'},
        [26] = {title = 'Torture', class = 'Felony', id = 'P.C. 1026', months = 20, fine = 4500, color = 'red', description = 'The act of causing harm to another to extract informaion and or for self enjoyment'},
    },
    [2] = {
        ...
        [2] = {title = 'Grand Theft', class = 'Misdemeanor', id = 'P.C. 2002', months = 2, fine = 800, color = 'green', description = 'Theft of property above $700'},
        [3] = {title = 'Grand Theft Auto A', class = 'Felony', id = 'P.C. 2003', months = 4, fine = 1400, color = 'green', description = 'The act of stealing a vehicle that belongs to someone else without permission'},
        [4] = {title = 'Grand Theft Auto B', class = 'Felony', id = 'P.C. 2004', months = 6, fine = 2000, color = 'green', description = 'The act of stealing a vehicle that belongs to someone else without permission while armed'},
        [5] = {title = 'Carjacking', class = 'Felony', id = 'P.C. 2005', months = 2, fine = 2000, color = 'orange', description = 'The act of someone forcefully taking a vehicle from its occupants'},
